# This Makefile is for the Acme::ctreptow extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Acme/ctreptow.pm]
#     AUTHOR => [q[Craig Treptow <craig.treptow@gmail.com>]]
#     BUILD_REQUIRES => {  }
#     LICENSE => q[perl]
#     NAME => q[Acme::ctreptow]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/Acme/ctreptow.pm]
#     clean => { FILES=>q[Acme-ctreptow-*] }
...
TO_INST_PM = lib/Acme/ctreptow.pm

PM_TO_BLIB = lib/Acme/ctreptow.pm \
	blib/lib/Acme/ctreptow.pm
...
DISTNAME = Acme-ctreptow
DISTVNAME = Acme-ctreptow-0.03
...
manifypods : pure_all  \
	lib/Acme/ctreptow.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Acme/ctreptow.pm $(INST_MAN3DIR)/Acme::ctreptow.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Acme-ctreptow' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.03' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           The great new Acme::ctreptow!' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Craig Treptow <craig.treptow@gmail.com>' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>The great new Acme::ctreptow!</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Craig Treptow &lt;craig.treptow@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Acme/ctreptow.pm blib/lib/Acme/ctreptow.pm 
